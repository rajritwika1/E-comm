      ...
      <footer className="footer">
        <div className="footer-container">
          <a className="footer-logo">
            <span className="logo-text">KanakSagar Traders</span>
          </a>
          <p className="footer-text">
            © 2025 KanakSagar —
            <Link to={'/'} className="footer-link" rel="noopener noreferrer" target="_blank">
              @KanakSagar
            </Link>
          </p>
          <span className="footer-icons">
            <a className="footer-icon">
              <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} className="icon" viewBox="0 0 24 24">
